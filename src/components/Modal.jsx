...
const Modal = ({ detailId, close }) => {
  ...
  // id her gücellendiğinde(detay'a basıldığında) çalışır
  useEffect(() => {
    // önceki uçuşun verilerini temizle (böylelikle arklı uçuşlara bastığımızda Loader görünebilsin)
    setDetail(null)
...
/*
 * Detay bilgilerini Modal bileşeninde bilmemiz gerekiyor. Ondan dolayo store'da tutmaya gerek yok
 * Biz başka bir sayfada bu Modal'ı kullanabiliriz. Ama Modal'da tuttuğum bilgileri o sayfada
 kullanmamıza gerek yok. Detay verilerini bilmemiz gereken tek yer bu Modal'ın içerisi. O yüzden
 state'de tuttuk.
 * Liste görünümü sayfasında veri yine Modal içinde kullanılacak. farklı bir bileşende kullanılmayacak
*/

/* <Link> etiketi yerine a etiketi kullanmamızın sebebi, proje içinde yönlendirme yapmıyoruz şu an.
proje içi yapsaydık Linl etiketi tercih ederdik */
